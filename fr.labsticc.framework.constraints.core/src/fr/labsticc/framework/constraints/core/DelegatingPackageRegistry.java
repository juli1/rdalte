...
/**
 * A package registry that delegates to multiple other registries.
...
public class DelegatingPackageRegistry extends EPackageRegistryImpl {
	...
	protected EPackage delegatedGetEPackage( final String p_nsURI ) {
		EPackage result = null;
		
		for ( final EPackage.Registry next : delegates ) {
			result = next.getEPackage( p_nsURI );
		}
