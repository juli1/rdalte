...
/**
 * This interface represents a deferred loading model for the Eclipse Modeling Framework (EMF).
 * @author <a href="mailto:dominique.blouin@univ-ubs.fr">Dominique BLOUIN</a>
 */
public interface IEMFDeferredLoadingModel extends IEMFModel, IDeferredLoadingModel {
}
