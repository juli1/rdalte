 ...
 * <ul>
 *   <li>{@link fr.openpeople.rdal.model.core.impl.VariableImpl#getFeature <em>Feature</em>}</li>
 *   <li>{@link fr.openpeople.rdal.model.core.impl.VariableImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableImpl extends IdentifiedElementImpl implements Variable {
	 ...
	 * @ordered
	 */
	protected static final VariableType TYPE_EDEFAULT = VariableType.MONITORED;
		...
		if (feature != null && feature.eIsProxy()) {
			...
			if (feature != oldFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.VARIABLE__FEATURE, oldFeature, feature));
			}
		}
		return feature;
	}
	...
	public void setFeature(EObject newFeature) {
		...
		feature = newFeature;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.VARIABLE__FEATURE, oldFeature, feature));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.VARIABLE__FEATURE:
