...
public class EMFConstraintValidationAS extends EObjectValidator implements IConstraintValidationAS  {

	private final AdapterFactory defaultAdapterFactory;

	public EMFConstraintValidationAS() {
	...
	throws ConstraintValidationException {
	    if ( p_diagnostic.getSeverity() != Diagnostic.OK ) {
	    	throw new ConstraintValidationException( p_diagnostic, p_diagnostic.getMessage() );
	    }
	}
