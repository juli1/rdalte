...
/**
 * This is the item provider adapter for a {@link fr.openpeople.rdal.model.core.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variable_feature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variable_feature_feature", "_UI_Variable_type"),
				 CorePackage.Literals.VARIABLE__FEATURE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CorePackage.Literals.VARIABLE__TYPE,
				 true,
				 false,
				 false,
