...
/**
 * This is the item provider adapter for a {@link fr.openpeople.rdal.model.core.RequirementsContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RequirementsContainer_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RequirementsContainer_type_feature", "_UI_RequirementsContainer_type"),
				 CorePackage.Literals.REQUIREMENTS_CONTAINER__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addRequirementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RequirementsContainer_requirement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RequirementsContainer_requirement_feature", "_UI_RequirementsContainer_type"),
				 CorePackage.Literals.REQUIREMENTS_CONTAINER__REQUIREMENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRequirementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RequirementsContainer_requirements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RequirementsContainer_requirements_feature", "_UI_RequirementsContainer_type"),
				 CorePackage.Literals.REQUIREMENTS_CONTAINER__REQUIREMENTS,
				 true,
				 false,
				 true,
				 null,
